...
func getNodeK8sScheduling(podReq *types.Pod) (affinity *corev1.Affinity, nodeSelector map[string]string, nodeName string) {
...
func (pc *Req2K8sConvert) PodReq2K8s(podReq *types.Pod) *corev1.Pod {
...
func (pc *Req2K8sConvert) getK8sHostAlias(podReqHostAliases []types.ListMapItem) []corev1.HostAlias {
...
func (pc *Req2K8sConvert) getK8sVolumes(podReqVolumes []types.Volume) []corev1.Volume {
...
func (pc *Req2K8sConvert) getK8sContainers(podReqContainers []types.Container) []corev1.Container {
...
func (pc *Req2K8sConvert) getK8sContainer(podReqContainer types.Container) corev1.Container {
...
func (pc *Req2K8sConvert) getK8sPorts(podReqPorts []types.ContainerPort) []corev1.ContainerPort {
...
func (pc *Req2K8sConvert) getK8sResources(podReqResources types.Resources) corev1.ResourceRequirements {
...
func (pc *Req2K8sConvert) getK8sContainerProbe(podReqProbe types.ContainerProbe) *corev1.Probe {
...
func (pc *Req2K8sConvert) getK8sVolumeMounts(podReqMounts []types.VolumeMount) []corev1.VolumeMount {
...
func (pc *Req2K8sConvert) getK8sEnvFrom(podReqEnvsFrom []types.EnvVarFromResource) []corev1.EnvFromSource {
...
func (pc *Req2K8sConvert) getK8sEnv(podReqEnv []types.EnvVar) []corev1.EnvVar {
...
func (pc *Req2K8sConvert) getK8sLabels(podReqLabels []types.ListMapItem) map[string]string {
